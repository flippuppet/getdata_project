...
* subject : integer representing the participant being measured
* activity : string labelling the type of activity such as walking etc, as described below under "Activity String Labels"
* tBodyAcc-mean-X
* tBodyAcc-mean-Y
* tBodyAcc-mean-Z
* tBodyAcc-std-X
...
## Activity String Labels
Activity string labels as indicated:
